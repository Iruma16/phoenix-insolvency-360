...
class TestEvidenceLocationContract:
    ...
    def test_valid_location_minimal(self):
        ...
        location = EvidenceLocation(
            start_char=0, end_char=100, extraction_method=ExtractionMethod.PDF_TEXT
        )
...
class TestLegalFindingContract:
    ...
    def test_valid_finding(self):
        ...
        finding = LegalFinding(
            statement="Afirmación objetiva basada en evidencia documental", evidence=[evidence]
        )
    ...
    def test_finding_with_short_statement_rejected(self):
        ...
        evidence = DocumentalEvidence(
            chunk_id="chunk_001", document_id="doc_001", location=location, content="texto"
        )
...
class TestLegalReportContract:
    ...
    def test_valid_report(self):
        ...
        finding = LegalFinding(
            statement="Afirmación objetiva respaldada por evidencia", evidence=[evidence]
        )
    ...
    def test_report_without_case_id_rejected(self):
        ...
        finding = LegalFinding(statement="Afirmación con evidencia", evidence=[evidence])
    ...
    def test_report_get_all_evidence_ids(self):
        ...
        evidences1 = [
            ...
            DocumentalEvidence(
                ...
                document_id="doc_001",
                location=EvidenceLocation(
                    start_char=100, end_char=200, extraction_method=ExtractionMethod.PDF_TEXT
                ),
                content="texto 2",
            ),
        ]
        ...
        evidences2 = [
            DocumentalEvidence(
                ...
                document_id="doc_002",
                location=EvidenceLocation(
                    start_char=0, end_char=50, extraction_method=ExtractionMethod.PDF_TEXT
                ),
                content="texto 3",
            )
        ]
        ...
        findings = [
            LegalFinding(statement="Hallazgo 1 con múltiples evidencias", evidence=evidences1),
            LegalFinding(statement="Hallazgo 2 con una evidencia", evidence=evidences2),
        ]
    ...
    def test_report_get_summary_stats(self):
        ...
        findings = [
            LegalFinding(statement="Hallazgo 1 con una evidencia", evidence=evidences1),
            LegalFinding(statement="Hallazgo 2 con dos evidencias", evidence=evidences2),
        ]
...
class TestNoAmbiguity:
    ...
    def test_every_statement_has_evidence(self):
        ...
        with pytest.raises(ValidationError):
            LegalFinding(statement="Afirmación sin respaldo", evidence=[])
