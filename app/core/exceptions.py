...
class ConfigurationException(PhoenixException):
    ...
    def __init__(self, message: str, **kwargs):
        super().__init__(
            code="CONFIG_ERROR", message=message, severity=ErrorSeverity.CRITICAL, **kwargs
        )
...
class DatabaseException(PhoenixException):
    ...
    def __init__(self, message: str, **kwargs):
        super().__init__(
            code="DATABASE_ERROR", message=message, severity=ErrorSeverity.HIGH, **kwargs
        )
...
class CaseNotFoundException(DatabaseException):
    ...
    def __init__(self, case_id: str, **kwargs):
        super().__init__(
            message=f"Caso no encontrado: {case_id}", details={"case_id": case_id}, **kwargs
        )
...
class RAGException(PhoenixException):
    ...
    def __init__(self, message: str, **kwargs):
        super().__init__(code="RAG_ERROR", message=message, severity=ErrorSeverity.MEDIUM, **kwargs)
...
class VectorstoreNotFoundException(RAGException):
    ...
    def __init__(self, path: str, **kwargs):
        super().__init__(
            message=f"Vectorstore no encontrado en: {path}", details={"path": path}, **kwargs
        )
...
class LLMException(PhoenixException):
    ...
    def __init__(self, message: str, **kwargs):
        super().__init__(code="LLM_ERROR", message=message, severity=ErrorSeverity.MEDIUM, **kwargs)
...
class LLMInvalidResponseException(LLMException):
    ...
    def __init__(self, reason: str, **kwargs):
        super().__init__(
            message=f"Respuesta inválida de LLM: {reason}", details={"reason": reason}, **kwargs
        )
...
class LegalAnalysisException(PhoenixException):
    ...
    def __init__(self, message: str, **kwargs):
        super().__init__(
            code="LEGAL_ANALYSIS_ERROR", message=message, severity=ErrorSeverity.MEDIUM, **kwargs
        )
...
class ReportGenerationException(PhoenixException):
    ...
    def __init__(self, message: str, **kwargs):
        super().__init__(
            code="REPORT_GENERATION_ERROR", message=message, severity=ErrorSeverity.MEDIUM, **kwargs
        )
...
class AuthenticationException(PhoenixException):
    ...
    def __init__(self, message: str = "Autenticación fallida", **kwargs):
        super().__init__(
            code="AUTH_ERROR", message=message, severity=ErrorSeverity.MEDIUM, **kwargs
        )
...
class InvalidTokenException(AuthenticationException):
    ...
    def __init__(self, reason: str = "Token inválido", **kwargs):
        super().__init__(message=f"Token inválido: {reason}", details={"reason": reason}, **kwargs)
...
class TokenExpiredException(AuthenticationException):
    ...
    def __init__(self, **kwargs):
        super().__init__(message="Token expirado", **kwargs)
...
class DocumentValidationError(PhoenixException):
    ...
    def __init__(self, reject_code: str, reason: str, filename: str, **kwargs):
        ...
        details = {"reject_code": reject_code, "reason": reason, "filename": filename}
...
def wrap_exception(
    original_error: Exception, phoenix_exception_class: type, **kwargs
) -> PhoenixException:
    """
    ...
    return phoenix_exception_class(original_error=original_error, **kwargs)
