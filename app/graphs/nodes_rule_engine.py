...
def apply_rule_engine(state: AuditState) -> AuditState:
    ...
    try:
        ...
        if not rulebook or not rulebook.rules:
            print(f"   ⚠️  No hay rulebook disponible, saltando rule engine")
        ...
        # TODO: Proveer contexto legal (por ahora vacío)
        legal_context = ""
        ...
        print(f"   ℹ️  Rulebook no encontrado, saltando rule engine")
        state["rule_based_findings"] = []
