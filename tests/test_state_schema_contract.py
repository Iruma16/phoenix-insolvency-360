...
def test_falla_clave_desconocida():
    ...
    with pytest.raises(ValidationError) as exc_info:
        PhoenixState(
            ...
            clave_inventada="esto no debe permitirse"
        )
...
def test_error_contiene_stage_y_field():
    ...
    try:
        ...
        print(f"✅ Error estructurado correctamente:")
        print(f"   {error_msg}")
...
def test_submodelos_validos():
    ...
    """
    from app.graphs.state_schema import Document, TimelineEvent, Risk
