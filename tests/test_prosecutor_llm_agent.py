...
def test_prosecutor_llm_disabled_response():
    ...
    result = agent.analyze(case_id="test_case", risks=[], legal_findings=[])
...
def test_prosecutor_llm_with_synthetic_data():
    ...
    result = agent.analyze(case_id="test_synthetic", risks=risks, legal_findings=legal_findings)
...
def test_prosecutor_llm_does_not_overwrite_heuristics():
    ...
    result = agent.analyze(
        case_id="test_no_overwrite", risks=original_risks, legal_findings=original_findings
    )
