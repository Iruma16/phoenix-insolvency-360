...
def test_generar_plantilla_desde_prosecutor_result(tmp_path, monkeypatch):
    ...
    assert plantilla.seccion_iii_riesgos_detectados.riesgos[0].titulo_riesgo == "Retraso en la Solicitud de Concurso"
    assert plantilla.seccion_iii_riesgos_detectados.calificacion_concursal_sugerida == "CULPABLE_AGRAVADO"
