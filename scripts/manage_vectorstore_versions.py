...
def cmd_cleanup(args):
    ...
    print("=" * 80)
    print("LIMPIEZA DE VERSIONES ANTIGUAS")
    print("=" * 80)
    print(f"case_id: {case_id}")
...
def main():
    parser = argparse.ArgumentParser(description="Gestión de versiones del vectorstore de casos")
    ...
    parser_cleanup.add_argument(
        "--keep", type=int, default=3, help="Versiones a mantener (default: 3)"
    )
