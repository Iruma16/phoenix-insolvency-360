...
def safe_delete_case_with_legal_check(
    ...
    """
    can_delete, reason = LegalRetentionPolicy.can_delete_case(
        case_id, case_created_at, category
    )
    
    # Log de auditoría
    LegalRetentionPolicy.log_deletion_attempt(
        case_id, can_delete, reason, requested_by
    )
