...
if __name__ == "__main__":
    ...
    for finding in result_001["legal_findings"]:
        ...
        print(
            f"   ✅ {finding['finding_type']}: {len(finding['legal_basis'])} artículos, {len(finding['risk_classification'])} clasificaciones"
        )
    ...
    accounting_finding = next(
        (
            f
            for f in result_003["legal_findings"]
    ...
    print("   ✅ Existe finding accounting_irregularities")
