...
def create_audit_report():
    ...
    doc.add_paragraph(
        "El análisis de liquidez revela una situación crítica:"
    )
...
def create_loan_contract():
    ...
    doc.add_paragraph(
        "En Madrid, a 15 de enero de 2022, COMPARECEN:"
    )
    ...
    # Firmas
    doc.add_paragraph("Y en prueba de conformidad, firman el presente contrato en el lugar y "
...
def main():
    ...
    print(f"📄 Archivos: 2 documentos Word")
