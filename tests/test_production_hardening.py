...
def test_retention_backend_selection():
    ...
    from app.services.retention_policy import RetentionConfig, get_retention_backend
...
def test_access_control_case_id_match():
    ...
    from app.services.access_control import AccessViolationError, assert_case_id_match
...
def test_access_control_chunk_validation():
    ...
    from app.services.access_control import AccessViolationError, validate_chunk_belongs_to_case
