...
class AnalysisResponse(BaseModel):
    ...
    quality_score: int = Field(
        ...,
        description="Score de calidad del análisis (0-100)",
        ge=0,
        le=100
    )
    ...
    llm_used: bool = Field(
        ...,
        description="Si se usó LLM en el análisis"
    )
...
async def analyze_case(
    ...
    try:
        ...
        response = AnalysisResponse(
            ...
            findings=[
                FindingResponse(**f) for f in result.get("findings", [])
            ],
