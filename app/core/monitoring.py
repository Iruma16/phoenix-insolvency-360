...
class PerformanceMonitor:
    ...
    @contextmanager
    def track_phase(self, phase_name: str, case_id: Optional[str] = None, **extra):
        """
    ...
    def track_case_analysis(self, case_id: str):
        ...
        logger.info("Iniciando análisis de caso", case_id=case_id, action="case_analysis_start")
        ...
        try:
            ...
            self.metrics.total_errors += 1
            logger.error(
                "Error en análisis de caso", case_id=case_id, action="case_analysis_error", error=e
            )
            raise
        finally:
    ...
    def get_metrics(self) -> dict[str, Any]:
        ...
        return {
            ...
            "llm": {
                ...
                "success_rate": (
                    round(
                        (self.metrics.llm_calls - self.metrics.llm_errors)
            ...
            "rag": {
                ...
                "success_rate": (
                    round(
                        (self.metrics.rag_queries - self.metrics.rag_errors)
