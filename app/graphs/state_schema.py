...
class PhoenixState(BaseModel):
    ...
    case_id: str = Field(
        ...,
        description="Identificador único del caso (OBLIGATORIO)"
    )
    ...
    case_context: CaseContext = Field(
        ...
        description="Contexto del caso y perfil de empresa"
    )
    
    inputs: Inputs = Field(
        default_factory=Inputs,
        description="Documentos y datos de entrada"
    )
    ...
    timeline: Timeline = Field(
        ...
        description="Timeline de eventos extraídos"
    )
    
    facts: Facts = Field(
        default_factory=Facts,
        description="Hechos probados y notas"
    )
    ...
    # ────────────────────────────────────────────────────────────
    risks: Risks = Field(
        default_factory=Risks,
        description="Riesgos heurísticos y findings legales"
    )
    
    legal_rules: LegalRulesEvaluation = Field(
        default_factory=LegalRulesEvaluation,
        description="Evaluación del Rule Engine"
    )
    ...
    rag_evidence: RagEvidence = Field(
        default_factory=RagEvidence,
        description="Chunks recuperados por RAG"
    )
    ...
    agents: AgentsOutput = Field(
        default_factory=AgentsOutput,
        description="Outputs de agentes LLM opcionales"
    )
    ...
    report: Optional[Report] = Field(
        default=None,
        description="Reporte final generado"
    )
    ...
    metrics: Metrics = Field(
        ...
        description="Métricas de ejecución"
    )
    
    errors: Errors = Field(
        default_factory=Errors,
        description="Errores de validación y ejecución"
    )
