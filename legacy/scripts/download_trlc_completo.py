...
def download_trlc_completo():
    ...
    try:
        ...
        if len(html_content) < 50000:
            raise ValueError(
                f"HTML descargado muy corto ({len(html_content)} chars). Probablemente error del BOE."
            )
        ...
        if len(texto_completo) < 500000:
            ...
            print("   El TRLC completo suele tener >1.000.000 caracteres")
        ...
        print("   2. Guardar la página completa como HTML")
        print(f"   3. Copiar a: {DOCS_DIR}/")
        print("   4. Ejecutar ingesta")
        raise
