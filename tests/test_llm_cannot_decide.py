...
from app.legal.rule_engine_output import RuleDecision, RuleEngineResult, RuleEngineResultBuilder
...
def test_llm_intenta_cambiar_severidad_falla():
    ...
    input_data = LegalExplanationInput(
        case_id="case_001",
        rules_triggered=[original_decision]
    )
...
def test_disclaimer_incluido_si_requerido():
    ...
    # Con disclaimer
    input_with = LegalExplanationInput(
        case_id="case_001",
    ...
    # Sin disclaimer
    input_without = LegalExplanationInput(
        case_id="case_001",
