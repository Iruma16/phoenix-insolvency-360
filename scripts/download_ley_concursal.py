...
def download_ley_concursal():
    ...
    try:
        ...
        texto_divs = soup.find_all('div', class_=re.compile(r'(texto|articulo|apartado|parrafo)', re.I))
        ...
        if len(texto) < 50000:
            ...
            print(f"   Esto podría indicar que no se descargó el texto completo.")
            print(f"   Se continuará pero verifica el resultado.")
        ...
        print(f"   ✅ Validación: contiene artículos legales")
...
if __name__ == "__main__":
    try:
        ...
        print(f"   python scripts/ingest_ley_completa.py")
    except Exception as e:
        print(f"\n💥 Falló la descarga: {e}")
        exit(1)
