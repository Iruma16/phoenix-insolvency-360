            ...
            with patch(
                ...
                with patch("app.rag.case_rag.service.query_case_rag") as mock_rag:
                    mock_rag.return_value = (
                        "Contexto simulado para el test. Documentos relevantes del caso."
                    )
                    ...
                    with patch("app.rag.legal_rag.service.query_legal_rag") as mock_legal_rag:
                        ...
                        try:
                            ...
                            print("   ✅ Handoff construido correctamente")
                        ...
                        try:
                            ...
                            if pdf_path.exists():
                                ...
                                print("   - PDF no generado (puede requerir librerías)")
                        except Exception as e:
                        ...
                        if db_files_in_root:
                            print(
                                f"   ⚠️  Archivos .db en la raíz: {[f.name for f in db_files_in_root]}"
                            )
                        else:
                            print("   ✅ No hay archivos .db en la raíz")
